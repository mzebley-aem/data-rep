...
/*# sourceMappingURL=index.css.map */`;let vt=class extends at{constructor(){super(),this.header="Title",this.insight="Insights",this.data=[],this.useH1=!1,this.explanationMaxCount=5,this.localization=void 0,this.total=0,this.showExplanation=!1,this.explanation="",this.showGlossaryBtn=!1,this.showGlossary=!1,this.previouslyFocusedElement=null,this.firstFocusableElement=null,this.lastFocusableElement=null,this.focusableElementsString='a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]',this.handleTabFromPanel=t=>{const e=this.shadowRoot.getElementById("glossarySwitchDisability"),i=this.shadowRoot.getElementById("explainSwitchDisability");"Tab"!==t.key||t.shiftKey?"Tab"===t.key&&t.shiftKey&&(t.preventDefault(),i.focus()):(t.preventDefault(),e.focus())},this.handleTabFromPlainLanguageBtn=t=>{const e=this.shadowRoot.getElementById("explainRegionDisability");"Tab"!==t.key||t.shiftKey||(t.preventDefault(),e.focus())},this.handleTabFromGlossaryBtn=t=>{const e=this.shadowRoot.getElementById("explainRegionDisability");"Tab"===t.key&&t.shiftKey&&(t.preventDefault(),e.focus())},this.trapTabKey=t=>{"Tab"===t.key?t.shiftKey?document.activeElement===this.firstFocusableElement&&(t.preventDefault(),this.lastFocusableElement.focus()):document.activeElement===this.lastFocusableElement&&(t.preventDefault(),this.firstFocusableElement.focus()):"Escape"===t.key&&this.closeModal()},this.showGlossaryBtn=!1,this.showGlossary=!1,this.showExplanation=!1,this.total=0,this.useH1=!1,this.localization=void 0,document.addEventListener("keydown",(t=>{"Escape"===t.key&&this.closeModal()}))}render(){var t,e,i;if(this.data.length){this.data[0].definition&&(this.showGlossaryBtn=!0),this.generateExplanation(),this.total=this.data.reduce(((t,e)=>t+e.value),0);const t=this.data.reduce(((t,e)=>Math.max(t,e.value)),this.data[0].value);this.data=this.data.map((e=>(e.percentage=e.value/this.total*100,e.largest=e.value===t,e.flexAmount=e.value/t,e))),this.data.sort(((t,e)=>e.value-t.value))}return I`
      <article>
        ...
        <div
          ...
          hidden="true"
        >
          ${ht(null!==(t=this.explanation)&&void 0!==t?t:"Error generating plain language summary.")}
        </div>
        <ol>
          ${this.data?this.data.map((t=>{var e;return I`
                  <li tabindex="0">
                    <div class="content">
                      <p class="label">${t.label}</p>
                      <p class="definition" aria-expanded="false" hidden="true">
                        ${ht(null!==(e=t.definition)&&void 0!==e?e:"Not defined.")}
                      </p>
                    </div>
      ...
      >
        <div class="modal-content" role="document">
          ...
          <h2 id="dataModalTitle">${null!==(e=this.header)&&void 0!==e?e:"Title"}</h2>
          <p class="description">${ht(null!==(i=this.insight)&&void 0!==i?i:"Insights")}</p>
          <div
            class="data-table"
            role="table"
