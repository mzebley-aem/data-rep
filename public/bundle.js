...
/*# sourceMappingURL=index.css.map */`;let ft;const mt=new Uint8Array(16);function bt(){if(!ft&&(ft="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!ft))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return ft(mt)}const vt=[];for(let xt=0;xt<256;++xt)vt.push((xt+256).toString(16).slice(1));var yt={randomUUID:"undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto)};function $t(t,e,i){if(yt.randomUUID&&!e&&!t)return yt.randomUUID();const r=(t=t||{}).random||(t.rng||bt)();if(r[6]=15&r[6]|64,r[8]=63&r[8]|128,e){i=i||0;for(let t=0;t<16;++t)e[i+t]=r[t];return e}return function(t,e=0){return vt[t[e+0]]+vt[t[e+1]]+vt[t[e+2]]+vt[t[e+3]]+"-"+vt[t[e+4]]+vt[t[e+5]]+"-"+vt[t[e+6]]+vt[t[e+7]]+"-"+vt[t[e+8]]+vt[t[e+9]]+"-"+vt[t[e+10]]+vt[t[e+11]]+vt[t[e+12]]+vt[t[e+13]]+vt[t[e+14]]+vt[t[e+15]]}(r)}let wt=class extends ot{constructor(){super(),this.uniqueIdPrefix="",this.header="Title",this.insight="Insights",this.data=[],this.useH1=!1,this.explanationMaxCount=5,this.localization=void 0,this.total=0,this.showExplanation=!1,this.explanation="",this.showGlossaryBtn=!1,this.showGlossary=!1,this.previouslyFocusedElement=null,this.firstFocusableElement=null,this.lastFocusableElement=null,this.focusableElementsString='a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], li[tabindex="0"], li[tabindex="-1"]',this.definitionIdsString="",this.handleTabFromPanel=t=>{const e=this.shadowRoot.getElementById(this.uniqueIdPrefix+"glossary-switch"),i=this.shadowRoot.getElementById(this.uniqueIdPrefix+"explanation-switch");"Tab"!==t.key||t.shiftKey?"Tab"===t.key&&t.shiftKey&&(t.preventDefault(),i.focus()):(t.preventDefault(),e.focus())},this.handleTabFromPlainLanguageBtn=t=>{const e=this.shadowRoot.getElementById(this.uniqueIdPrefix+"explanation-region");"Tab"!==t.key||t.shiftKey||(t.preventDefault(),e.focus())},this.handleTabFromGlossaryBtn=t=>{const e=this.shadowRoot.getElementById(this.uniqueIdPrefix+"explanation-region");"Tab"===t.key&&t.shiftKey&&(t.preventDefault(),e.focus())},this.trapTabKey=t=>{"Tab"===t.key?t.shiftKey?document.activeElement===this.firstFocusableElement&&(t.preventDefault(),this.lastFocusableElement.focus()):document.activeElement===this.lastFocusableElement&&(t.preventDefault(),this.firstFocusableElement.focus()):"Escape"===t.key&&this.closeModal()},this.togglePlainLanguage=this.togglePlainLanguage.bind(this),this.toggleGlossary=this.toggleGlossary.bind(this),this.uniqueIdPrefix=$t().slice(0,9),this.showGlossaryBtn=!1,this.showGlossary=!1,this.showExplanation=!1,this.total=0,this.useH1=!1,this.localization=void 0,document.addEventListener("keydown",(t=>{"Escape"===t.key&&this.closeModal()}))}render(){var t,e,i;if(this.data.length){this.data[0].definition&&(this.showGlossaryBtn=!0),this.generateExplanation(),this.total=this.data.reduce(((t,e)=>t+e.value),0);const t=this.data.reduce(((t,e)=>Math.max(t,e.value)),this.data[0].value),e=[];this.data=this.data.map(((i,r)=>(i.percentage=i.value/this.total*100,i.largest=i.value===t,i.flexAmount=i.value/t,e.push(this.uniqueIdPrefix+"series-item-definition-"+r),i))),this.data.sort(((t,e)=>e.value-t.value)),this.definitionIdsString=e.join(", ")}return N`
      <article class="data-rep-wrapper" aria-labelledby="${this.uniqueIdPrefix}title" aria-describedby="${this.uniqueIdPrefix}insight">
        ${this.useH1?N`<h1 id="${this.uniqueIdPrefix}title" class="title">${this.header}</h1>`:N`<h2 id="${this.uniqueIdPrefix}title" class="title">${this.header}</h2>`}
        ...
        <ol id="${this.uniqueIdPrefix}series" class="series">
          ${this.data?this.data.map(((t,e)=>{var i;return N`
                  <li tabindex="0" id="${this.uniqueIdPrefix}series-item-${e}" aria-describedby="${this.uniqueIdPrefix}series-item-label-${e} ${this.uniqueIdPrefix}-series-item-percentage-${e} ${this.uniqueIdPrefix}-series-item-value-${e}">
                    <span class="content">
                      <p class="label" id="${this.uniqueIdPrefix}series-item-label-${e}">${t.label}</p>
                      <p class="definition" id="${this.uniqueIdPrefix}series-item-definition-${e}" aria-expanded="false" hidden="true">
                    ...
                    <div class="bar-wrapper">
                      ...
                      ></div>
                      <ul class="details">
                        <li class="percentage" id="${this.uniqueIdPrefix}series-item-percentage-${e}">
                          ${t.percentage?t.percentage.toLocaleString(this.localization,{minimumFractionDigits:2,maximumFractionDigits:2}):0}%
                        </li>
                        <li class="value" id="${this.uniqueIdPrefix}series-item-value-${e}">
